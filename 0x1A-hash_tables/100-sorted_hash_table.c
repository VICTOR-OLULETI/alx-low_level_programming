 ...
 * Return: the created shash table, or NULL if it fails
 */
...
/**
 * add_n_shash - adds a node at the beginning of a shasha at a given index
...
/**
 * shash_table delete - deletes a shash table
 *
 * @ht: pointer to the shash table
 * Return: no return.
 */
